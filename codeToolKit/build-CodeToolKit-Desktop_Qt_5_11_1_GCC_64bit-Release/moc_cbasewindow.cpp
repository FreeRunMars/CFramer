...
#include "../CodeToolKit/CTK/cbasewindow.h"
...
QT_INIT_METAOBJECT const QMetaObject CBaseWindow::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_CBaseWindow.data,
